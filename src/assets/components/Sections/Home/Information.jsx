        ...
        <div className='info-parent'>
            <div className='info-card'>
                <div className='icon-container'>
                    <img src="./src/assets/images/shipping.svg" alt="shipping icon" />
                </div>   
                <h2>Free Shipping</h2>
            ...
            <div className='info-card'>
                <div className='icon-container'>
                    <img src="./src/assets/images/secure.svg" alt="shipping icon" />
                </div>   
                ...
                <div className='info-card'>
                    <div className='icon-container'>
                        <img src="./src/assets/images/customer.svg" alt="shipping icon" />
                    </div>   
